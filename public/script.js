...
if (!window.WhisperBrew) {
  // Use window.BREWING_RECIPES to be extra safe
  window.BREWING_RECIPES = window.BREWING_RECIPES || {
    oneCup: [
  ...
  console.log(
    ...
    window.BREWING_RECIPES.oneCup.slice(0,3),
    window.BREWING_RECIPES.twoCup.slice(0,3)
  );
