...
const WHISPER_BREW_MAX_WAIT_MS = 4000; // 4 seconds for max wait
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background">
      <div className="container">
            ...
            {loadingError ? (
              <>
                <span className="text-red-600 text-lg font-bold">
                  Failed to load brewing system. Try again.
                </span>
                <button
              ...
              <span className="text-coffee-dark text-lg font-bold animate-pulse">
                Loading brewing system...
              </span>
            )}
          </div>
        )}
        ...
        <div
          id="home-screen"
          className="text-center space-y-12 p-8 fade-in max-w-md mx-auto py-0 px-0"
        >
        ...
        >
          <div className="flex flex-col items-center justify-center w-full max-w-lg mx-auto pt-6 pb-10 py-0">
            ...
            <p className="text-coffee-medium text-lg md:text-xl mt-6 mb-12">
              Let it drain out. Enjoy your cup
            </p>
            <button
